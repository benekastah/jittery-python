...
tuple = function () {
  ...
  tuple.prototype.__init__ = function (self, iterable) {
    var __self__, sup, __i_20577__, __len_61930__, __iter_81645__, item, len, index;
    __self__ = arguments[0];
    sup = __self__.$super();
    for (__i_20577__ = 0, __iter_81645__ = iterable, __len_61930__ = __iter_81645__.length; __i_20577__ < __len_61930__; __i_20577__++) {
      item = __iter_81645__[__i_20577__];
      len = sup.push(item);
      index = len - 1;
...
print = function () {
  ...
  string = sep.join(function () {
    var __result_70657__, __i_1229__, __len_94648__, __iter_61204__, o;
    __result_70657__ = [];
    for (__i_1229__ = 0, __iter_61204__ = objects, __len_94648__ = __iter_61204__.length; __i_1229__ < __len_94648__; __i_1229__++) {
      o = __iter_61204__[__i_1229__];
      __result_70657__.push(str(o));
    };
    return __result_70657__;
  }()) + end;
  console.log(string);
};
...
__python__.register_module("__main__", function (____main___35468__) {
  ____main___35468__.a = new tuple([1, 2, 3, 4, 5, 6, 7]);
  print(____main___35468__._a = __slice__(____main___35468__.a, null, null, 4));
});
