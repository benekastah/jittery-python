...
tuple = function () {
  ...
  tuple.prototype.__init__ = function (self, iterable) {
    var __self__, sup, __i_30392__, __len_75384__, __iter_95136__, item, len, index;
    __self__ = arguments[0];
    sup = __self__.$super();
    for (__i_30392__ = 0, __iter_95136__ = iterable, __len_75384__ = __iter_95136__.length; __i_30392__ < __len_75384__; __i_30392__++) {
      item = __iter_95136__[__i_30392__];
      len = sup.push(item);
      index = len - 1;
...
print = function () {
  ...
  string = sep.join(function () {
    var __result_77963__, __i_69378__, __len_66558__, __iter_61693__, o;
    __result_77963__ = [];
    for (__i_69378__ = 0, __iter_61693__ = objects, __len_66558__ = __iter_61693__.length; __i_69378__ < __len_66558__; __i_69378__++) {
      o = __iter_61693__[__i_69378__];
      __result_77963__.push(str(o));
    };
    return __result_77963__;
  }()) + end;
  console.log(string);
};
...
__python__.register_module("__main__", function (____main___28126__) {
  ____main___28126__.a = new tuple([1, 2, 3, 4, 5, 6, 7]);
  print(____main___28126__._a = __slice__(____main___28126__.a, null, null, 4));
});
