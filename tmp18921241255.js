...
tuple = function () {
  ...
  tuple.prototype.__init__ = function (self, iterable) {
    var __self__, sup, __i_42236__, __len_41869__, __iter_6451__, item, len, index;
    __self__ = arguments[0];
    sup = __self__.$super();
    for (__i_42236__ = 0, __iter_6451__ = iterable, __len_41869__ = __iter_6451__.length; __i_42236__ < __len_41869__; __i_42236__++) {
      item = __iter_6451__[__i_42236__];
      len = sup.push(item);
      index = len - 1;
...
print = function () {
  ...
  string = sep.join(function () {
    var __result_93833__, __i_5438__, __len_99811__, __iter_42548__, o;
    __result_93833__ = [];
    for (__i_5438__ = 0, __iter_42548__ = objects, __len_99811__ = __iter_42548__.length; __i_5438__ < __len_99811__; __i_5438__++) {
      o = __iter_42548__[__i_5438__];
      __result_93833__.push(str(o));
    };
    return __result_93833__;
  }()) + end;
  console.log(string);
};
...
__python__.register_module("__main__", function (____main___64096__) {
  ____main___64096__.a = new tuple([1, 2, 3, 4, 5, 6, 7]);
  print(____main___64096__._a = __slice__(____main___64096__.a, null, null, 4));
});
