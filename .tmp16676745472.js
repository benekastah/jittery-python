...
tuple = function () {
  ...
  tuple.prototype.__init__ = function (self, iterable) {
    var __self__, sup, __i_76241__, __len_16901__, __iter_38524__, item, len, index;
    __self__ = arguments[0];
    sup = __self__.$super();
    for (__i_76241__ = 0, __iter_38524__ = iterable, __len_16901__ = __iter_38524__.length; __i_76241__ < __len_16901__; __i_76241__++) {
      item = __iter_38524__[__i_76241__];
      len = sup.push(item);
      index = len - 1;
...
print = function () {
  ...
  string = sep.join(function () {
    var __result_73698__, __i_52022__, __len_11996__, __iter_94900__, o;
    __result_73698__ = [];
    for (__i_52022__ = 0, __iter_94900__ = objects, __len_11996__ = __iter_94900__.length; __i_52022__ < __len_11996__; __i_52022__++) {
      o = __iter_94900__[__i_52022__];
      __result_73698__.push(str(o));
    };
    return __result_73698__;
  }()) + end;
  console.log(string);
};
...
__python__.register_module("__main__", function (____main___92799__) {
  ____main___92799__.a = new tuple([1, 2, 3, 4, 5, 6, 7]);
  print(____main___92799__._a = __slice__(____main___92799__.a, null, null, 4));
});
