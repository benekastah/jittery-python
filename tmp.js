...
print = function () {
  ...
  string = sep.join(function () {
    var __result_20266__, __i_20030__, __len_60622__, __iter_77014__, o;
    __result_20266__ = [];
    for (__i_20030__ = 0, __iter_77014__ = objects, __len_60622__ = __iter_77014__.length; __i_20030__ < __len_60622__; __i_20030__++) {
      o = __iter_77014__[__i_20030__];
      __result_20266__.push(str(o));
    };
    return __result_20266__;
  }()) + end;
  console.log(string);
};
__eq__ = function (a, b) {
...
__registermodule__("__main__", function (____main___52688__) {
  ____main___52688__.o = object();
});
