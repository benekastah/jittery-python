...
tuple = function () {
  ...
  tuple.prototype.__init__ = function (self, iterable) {
    var __self__, sup, __i_21003__, __len_10795__, __iter_53662__, item, len, index;
    __self__ = arguments[0];
    sup = __self__.$super();
    for (__i_21003__ = 0, __iter_53662__ = iterable, __len_10795__ = __iter_53662__.length; __i_21003__ < __len_10795__; __i_21003__++) {
      item = __iter_53662__[__i_21003__];
      len = sup.push(item);
      index = len - 1;
...
print = function () {
  ...
  string = sep.join(function () {
    var __result_74181__, __i_67159__, __len_64820__, __iter_92029__, o;
    __result_74181__ = [];
    for (__i_67159__ = 0, __iter_92029__ = objects, __len_64820__ = __iter_92029__.length; __i_67159__ < __len_64820__; __i_67159__++) {
      o = __iter_92029__[__i_67159__];
      __result_74181__.push(str(o));
    };
    return __result_74181__;
  }()) + end;
  console.log(string);
};
...
__registermodule__("__main__", function (____main___95682__) {
  ____main___95682__.a = new tuple([1, 2, 3, 4, 5, 6, 7]);
  print(____main___95682__._a = __slice__(____main___95682__.a, null, null, 4));
});
