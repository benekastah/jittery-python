...
tuple = function () {
  ...
  tuple.prototype.__init__ = function (self, iterable) {
    var __self__, sup, __i_71755__, __len_37637__, __iter_12439__, item, len, index;
    __self__ = arguments[0];
    sup = __self__.$super();
    for (__i_71755__ = 0, __iter_12439__ = iterable, __len_37637__ = __iter_12439__.length; __i_71755__ < __len_37637__; __i_71755__++) {
      item = __iter_12439__[__i_71755__];
      len = sup.push(item);
      index = len - 1;
...
print = function () {
  ...
  string = sep.join(function () {
    var __result_78274__, __i_16544__, __len_43312__, __iter_62368__, o;
    __result_78274__ = [];
    for (__i_16544__ = 0, __iter_62368__ = objects, __len_43312__ = __iter_62368__.length; __i_16544__ < __len_43312__; __i_16544__++) {
      o = __iter_62368__[__i_16544__];
      __result_78274__.push(str(o));
    };
    return __result_78274__;
  }()) + end;
  console.log(string);
};
...
__python__.register_module("__main__", function (____main___49305__) {
  ____main___49305__.a = new tuple([1, 2, 3, 4, 5, 6, 7]);
  print(____main___49305__._a = __slice__(____main___49305__.a, null, null, 4));
});
